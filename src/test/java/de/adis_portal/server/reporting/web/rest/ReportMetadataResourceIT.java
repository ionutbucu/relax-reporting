...
class ReportMetadataResourceIT {
    ...
    void getAllReportMetadata() throws Exception {
        ...
        restReportMetadataMockMvc
            ...
            .andExpect(jsonPath("$.[*].rid").value(hasItem(reportMetadata.getRid())))
    ...
    void getReportMetadata() throws Exception {
        ...
        restReportMetadataMockMvc
            .perform(get(ENTITY_API_URL_ID, reportMetadata.getRid()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.rid").value(reportMetadata.getRid()))
    ...
    void putExistingReportMetadata() throws Exception {
        ...
        ReportMetadata updatedReportMetadata = reportMetadataRepository.findById(reportMetadata.getRid()).orElseThrow();
        ...
        restReportMetadataMockMvc
            .perform(
                put(ENTITY_API_URL_ID, reportMetadataDTO.getRid())
    ...
    void partialUpdateReportMetadataWithPatch() throws Exception {
        ...
        restReportMetadataMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedReportMetadata.getRid())
    ...
    void patchNonExistingReportMetadata() throws Exception {
        ...
        restReportMetadataMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, reportMetadataDTO.getRid())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(reportMetadataDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteReportMetadata() throws Exception {
        ...
        restReportMetadataMockMvc
            .perform(delete(ENTITY_API_URL_ID, reportMetadata.getRid()).accept(MediaType.APPLICATION_JSON))
    ...
    protected ReportMetadata getPersistedReportMetadata(ReportMetadata reportMetadata) {
        return reportMetadataRepository.findById(reportMetadata.getRid()).orElseThrow();
    }
