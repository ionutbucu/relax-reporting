...
class ReportDataSourceResourceIT {
    ...
    void getAllReportDataSources() throws Exception {
        ...
        restReportDataSourceMockMvc
            ...
            .andExpect(jsonPath("$.[*].rid").value(hasItem(reportDataSource.getRid())))
    ...
    void getReportDataSource() throws Exception {
        ...
        restReportDataSourceMockMvc
            .perform(get(ENTITY_API_URL_ID, reportDataSource.getRid()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.rid").value(reportDataSource.getRid()))
    ...
    void putExistingReportDataSource() throws Exception {
        ...
        ReportDataSource updatedReportDataSource = reportDataSourceRepository.findById(reportDataSource.getRid()).orElseThrow();
        ...
        restReportDataSourceMockMvc
            .perform(
                put(ENTITY_API_URL_ID, reportDataSourceDTO.getRid())
    ...
    void partialUpdateReportDataSourceWithPatch() throws Exception {
        ...
        restReportDataSourceMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedReportDataSource.getRid())
    ...
    void patchNonExistingReportDataSource() throws Exception {
        ...
        restReportDataSourceMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, reportDataSourceDTO.getRid())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(reportDataSourceDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteReportDataSource() throws Exception {
        ...
        restReportDataSourceMockMvc
            .perform(delete(ENTITY_API_URL_ID, reportDataSource.getRid()).accept(MediaType.APPLICATION_JSON))
    ...
    protected ReportDataSource getPersistedReportDataSource(ReportDataSource reportDataSource) {
        return reportDataSourceRepository.findById(reportDataSource.getRid()).orElseThrow();
    }
