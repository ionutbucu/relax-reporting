...
class ReportScheduleResourceIT {
    ...
    void getAllReportSchedules() throws Exception {
        ...
        restReportScheduleMockMvc
            ...
            .andExpect(jsonPath("$.[*].rid").value(hasItem(reportSchedule.getRid())))
    ...
    void getReportSchedule() throws Exception {
        ...
        restReportScheduleMockMvc
            .perform(get(ENTITY_API_URL_ID, reportSchedule.getRid()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.rid").value(reportSchedule.getRid()))
    ...
    void putExistingReportSchedule() throws Exception {
        ...
        ReportSchedule updatedReportSchedule = reportScheduleRepository.findById(reportSchedule.getRid()).orElseThrow();
        ...
        restReportScheduleMockMvc
            .perform(
                put(ENTITY_API_URL_ID, reportScheduleDTO.getRid())
    ...
    void partialUpdateReportScheduleWithPatch() throws Exception {
        ...
        restReportScheduleMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedReportSchedule.getRid())
    ...
    void patchNonExistingReportSchedule() throws Exception {
        ...
        restReportScheduleMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, reportScheduleDTO.getRid())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(reportScheduleDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteReportSchedule() throws Exception {
        ...
        restReportScheduleMockMvc
            .perform(delete(ENTITY_API_URL_ID, reportSchedule.getRid()).accept(MediaType.APPLICATION_JSON))
    ...
    protected ReportSchedule getPersistedReportSchedule(ReportSchedule reportSchedule) {
        return reportScheduleRepository.findById(reportSchedule.getRid()).orElseThrow();
    }
