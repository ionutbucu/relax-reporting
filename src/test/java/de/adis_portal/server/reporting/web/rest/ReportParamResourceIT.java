...
class ReportParamResourceIT {
    ...
    void getAllReportParams() throws Exception {
        ...
        restReportParamMockMvc
            ...
            .andExpect(jsonPath("$.[*].rid").value(hasItem(reportParam.getRid())))
    ...
    void getReportParam() throws Exception {
        ...
        // Get the reportParam
        restReportParamMockMvc
            .perform(get(ENTITY_API_URL_ID, reportParam.getRid()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.rid").value(reportParam.getRid()))
    ...
    void putExistingReportParam() throws Exception {
        ...
        ReportParam updatedReportParam = reportParamRepository.findById(reportParam.getRid()).orElseThrow();
        ...
        restReportParamMockMvc
            .perform(
                put(ENTITY_API_URL_ID, reportParamDTO.getRid())
    ...
    void partialUpdateReportParamWithPatch() throws Exception {
        ...
        restReportParamMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedReportParam.getRid())
    ...
    void patchNonExistingReportParam() throws Exception {
        ...
        restReportParamMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, reportParamDTO.getRid())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(reportParamDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteReportParam() throws Exception {
        ...
        restReportParamMockMvc
            .perform(delete(ENTITY_API_URL_ID, reportParam.getRid()).accept(MediaType.APPLICATION_JSON))
    ...
    protected ReportParam getPersistedReportParam(ReportParam reportParam) {
        return reportParamRepository.findById(reportParam.getRid()).orElseThrow();
    }
