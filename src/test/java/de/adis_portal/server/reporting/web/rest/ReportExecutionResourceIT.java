...
class ReportExecutionResourceIT {
    ...
    void getAllReportExecutions() throws Exception {
        ...
        restReportExecutionMockMvc
            ...
            .andExpect(jsonPath("$.[*].rid").value(hasItem(reportExecution.getRid())))
    ...
    void getReportExecution() throws Exception {
        ...
        restReportExecutionMockMvc
            .perform(get(ENTITY_API_URL_ID, reportExecution.getRid()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.rid").value(reportExecution.getRid()))
    ...
    void putExistingReportExecution() throws Exception {
        ...
        ReportExecution updatedReportExecution = reportExecutionRepository.findById(reportExecution.getRid()).orElseThrow();
        ...
        restReportExecutionMockMvc
            .perform(
                put(ENTITY_API_URL_ID, reportExecutionDTO.getRid())
    ...
    void partialUpdateReportExecutionWithPatch() throws Exception {
        ...
        partialUpdatedReportExecution.date(UPDATED_DATE).error(UPDATED_ERROR).url(UPDATED_URL).additionalInfo(UPDATED_ADDITIONAL_INFO);

        restReportExecutionMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedReportExecution.getRid())
    ...
    void patchNonExistingReportExecution() throws Exception {
        ...
        restReportExecutionMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, reportExecutionDTO.getRid())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(reportExecutionDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteReportExecution() throws Exception {
        ...
        restReportExecutionMockMvc
            .perform(delete(ENTITY_API_URL_ID, reportExecution.getRid()).accept(MediaType.APPLICATION_JSON))
    ...
    protected ReportExecution getPersistedReportExecution(ReportExecution reportExecution) {
        return reportExecutionRepository.findById(reportExecution.getRid()).orElseThrow();
    }
