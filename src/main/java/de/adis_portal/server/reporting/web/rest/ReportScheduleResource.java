...
public class ReportScheduleResource {
    ...
    public ResponseEntity<ReportScheduleDTO> createReportSchedule(@Valid @RequestBody ReportScheduleDTO reportScheduleDTO)
        ...
        if (reportScheduleDTO.getId() != null) {
            throw new BadRequestAlertException("A new reportSchedule cannot already have an ID", ENTITY_NAME, "idexists");
        }
        reportScheduleDTO = reportScheduleService.save(reportScheduleDTO);
        return ResponseEntity.created(new URI("/api/report-schedules/" + reportScheduleDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, reportScheduleDTO.getId().toString()))
            .body(reportScheduleDTO);
    }

    /**
     * {@code PUT  /report-schedules/:id} : Updates an existing reportSchedule.
     *
     * @param id the id of the reportScheduleDTO to save.
    ...
    public ResponseEntity<ReportScheduleDTO> updateReportSchedule(
        ...
        log.debug("REST request to update ReportSchedule : {}, {}", id, reportScheduleDTO);
        if (reportScheduleDTO.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(id, reportScheduleDTO.getId())) {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, reportScheduleDTO.getId().toString()))
            .body(reportScheduleDTO);
    }

    /**
     * {@code PATCH  /report-schedules/:id} : Partial updates given fields of an existing reportSchedule, field will ignore if it is null
     *
     * @param id the id of the reportScheduleDTO to save.
     * @param reportScheduleDTO the reportScheduleDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated reportScheduleDTO,
    ...
    public ResponseEntity<ReportScheduleDTO> partialUpdateReportSchedule(
        ...
        log.debug("REST request to partial update ReportSchedule partially : {}, {}", id, reportScheduleDTO);
        if (reportScheduleDTO.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(id, reportScheduleDTO.getId())) {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, reportScheduleDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<ReportScheduleDTO> getReportSchedule(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteReportSchedule(@PathVariable("id") Long id) {
