...
public class ReportDistributionResource {
    ...
    public ResponseEntity<ReportDistributionDTO> createReportDistribution(@Valid @RequestBody ReportDistributionDTO reportDistributionDTO)
        ...
        if (reportDistributionRepository.existsById(reportDistributionDTO.getRid())) {
            throw new BadRequestAlertException("reportDistribution already exists", ENTITY_NAME, "idexists");
        }
        reportDistributionDTO = reportDistributionService.save(reportDistributionDTO);
        return ResponseEntity.created(new URI("/api/report-distributions/" + reportDistributionDTO.getRid()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, reportDistributionDTO.getRid()))
    ...
    public ResponseEntity<ReportDistributionDTO> updateReportDistribution(
        ...
        if (!reportDistributionRepository.existsById(rid)) {
            throw new BadRequestAlertException("Entity not found", ENTITY_NAME, "idnotfound");
        }

        reportDistributionDTO = reportDistributionService.update(reportDistributionDTO);
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, reportDistributionDTO.getRid()))
            .body(reportDistributionDTO);
    }
    ...
    public ResponseEntity<ReportDistributionDTO> partialUpdateReportDistribution(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, reportDistributionDTO.getRid())
        );
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<ReportDistributionDTO> getReportDistribution(@PathVariable("id") String id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteReportDistribution(@PathVariable("id") String id) {
