...
import { sampleWithRequiredData } from '../report-schedule.test-samples';
...
describe('ReportSchedule Management Component', () => {
  let comp: ReportScheduleComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ReportScheduleComponent],
      providers: [
        {
      ...
      .overrideTemplate(ReportScheduleComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.reportSchedules?.[0]).toEqual(expect.objectContaining({ rid: 'ABC' }));
  });

  describe('trackRid', () => {
    it('Should forward to reportScheduleService', () => {
      const entity = { rid: 'ABC' };
      jest.spyOn(service, 'getReportScheduleIdentifier');
      const rid = comp.trackRid(0, entity);
      expect(service.getReportScheduleIdentifier).toHaveBeenCalledWith(entity);
