...
describe('ReportDataSource Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should update editForm', () => {
      const reportDataSource: IReportDataSource = { id: 456 };
  ...
  describe('save', () => {
    ...
    it('Should call create service on save for new entity', () => {
      ...
      const saveSubject = new Subject<HttpResponse<IReportDataSource>>();
      const reportDataSource = { id: 123 };
      jest.spyOn(reportDataSourceFormService, 'getReportDataSource').mockReturnValue({ id: null });
