...
export type PartialUpdateReportDataSource = Partial<IReportDataSource> & Pick<IReportDataSource, 'id'>;
...
export class ReportDataSourceService {
  ...
  getReportDataSourceIdentifier(reportDataSource: Pick<IReportDataSource, 'id'>): number {
    return reportDataSource.id;
  }

  compareReportDataSource(o1: Pick<IReportDataSource, 'id'> | null, o2: Pick<IReportDataSource, 'id'> | null): boolean {
    return o1 && o2 ? this.getReportDataSourceIdentifier(o1) === this.getReportDataSourceIdentifier(o2) : o1 === o2;
  }

  addReportDataSourceToCollectionIfMissing<Type extends Pick<IReportDataSource, 'id'>>(
