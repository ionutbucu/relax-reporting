...
describe('ReportColumnMapping Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Report query and add missing value', () => {
      const reportColumnMapping: IReportColumnMapping = { id: 456 };
      const report: IReport = { id: 4563 };
      reportColumnMapping.report = report;

      const reportCollection: IReport[] = [{ id: 22161 }];
  ...
  describe('save', () => {
    it('Should call update service on save for existing entity', () => {
      ...
      const reportColumnMapping = { id: 123 };
    ...
    it('Should call create service on save for new entity', () => {
      ...
      const saveSubject = new Subject<HttpResponse<IReportColumnMapping>>();
      const reportColumnMapping = { id: 123 };
      jest.spyOn(reportColumnMappingFormService, 'getReportColumnMapping').mockReturnValue({ id: null });
